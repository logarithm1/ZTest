...
import alorighms.practics.Graph.Edge;
...
public class practics {
	...
	private void linkedadd() {
		...
		while(!stack1.isEmpty() && !stack2.isEmpty()) {
			int v1 = stack1.remove().val;
			int v2 = stack2.remove().val;
